...
class TorrentManagerTests {
	// MARK: - Test Setup
	private let mockPreferences: MockAppPreferences
	private let mockSession: MockSession
	private let mockClient: MockTorrentClientActing
	private let torrentManager: TorrentManager

	init() {
		mockPreferences = MockAppPreferences()
		mockSession = MockSession(mockPreferences)
		mockClient = MockTorrentClientActing()
