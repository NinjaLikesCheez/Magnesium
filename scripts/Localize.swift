 ...
 */
let relativeLocalizableFolders = "Magnesium/Resources/Localization"
 ...
 */
let relativeSourceFolder = "Magnesium"
...
func listSupportedLanguages() -> [String] {
    var sl = [String]()
    let path = (FileManager.default.currentDirectoryPath as NSString).appendingPathComponent(relativeLocalizableFolders)
...
let sourcesPath = (FileManager.default.currentDirectoryPath as NSString).appendingPathComponent(relativeSourceFolder)
