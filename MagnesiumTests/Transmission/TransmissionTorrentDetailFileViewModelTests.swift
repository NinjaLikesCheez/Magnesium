//
//  TransmissionTorrentDetailFileViewModelTests.swift
//  MagnesiumTests
//
...
class TransmissionTorrentDetailFileViewModelTests: XCTestCase {
    private let subject = CurrentValueSubject<TransmissionTorrentFile, Never>(.mock(
        index: 0,
        name: "file.rar",
        progress: 0.189838
    ))
